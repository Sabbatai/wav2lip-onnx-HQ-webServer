...
def initialize_models():
    ...
    global detector, recognition, trt_runtime, trt_engine, trt_context
    ...
    print(f"\n🚀 Server ready! TensorRT optimized for RTX 4090")
...
def infer_trt(img_batch, mel_batch):
    ...
    # Run inference (use default stream for now)
    success = trt_context.execute_async_v3(torch.cuda.current_stream().cuda_stream)
